...
func TestListAssets(t *testing.T) {
	...
	for _, expected := range []struct {
		...
		{Chain: pbblockchain.Chain_CHAIN_ANY, Assets: []string{"01K40YW14CPAYUNICHAINUSDT0"}},
		{Chain: pbblockchain.Chain_CHAIN_BTC_BITCOIN, Assets: nil},
		{Chain: pbblockchain.Chain_CHAIN_EVM_UNICHAIN, Assets: []string{"01K40YW14CPAYUNICHAINUSDT0"}},
	} {
